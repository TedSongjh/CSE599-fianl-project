...
seq = '2019_10_13_ONRD048_CS_NIGHT'
cruw_data_root = os.path.join('/mnt/disk1/CRUW/CRUW_MINI/sequences/',seq)
...
def visualize(im, instance, save_path=None):
    ...
    v = Visualizer(im[:, :, ::-1], MetadataCatalog.get('nuimages_test'), scale=1.2)
...
if __name__ == '__main__':
    ...
    for seq in seq_names:
        ...
        for image_name in image_names0:
            ...
            save_path = os.path.join(nuimage_infer_root, 'vis', seq, model_name, image_name)
            if not os.path.exists(os.path.join(nuimage_infer_root, 'vis', seq, model_name)):
                os.makedirs(os.path.join(nuimage_infer_root, 'vis', seq, model_name))
